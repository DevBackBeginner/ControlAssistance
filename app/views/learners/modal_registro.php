                ...
                <?php if (empty($aprendiz['hora_entrada'])): ?>
                    ...
                    <div id="fase-2-<?= $aprendizId ?>" style="display: none;">
                        ...
                        <div class="d-flex gap-2">
                            ...
                            <button type="button" class="btn btn-secondary w-100" onclick="finalizarProceso('<?= $aprendizId ?>')">No</button>
                        </div>
                    </div>
                    ...
                    <div id="fase-3-<?= $aprendizId ?>" style="display: none;">
                        <?php if (empty($computadores)): ?>
                            <!-- Formulario para registrar nuevo computador -->
                            <div class="form-group mb-3">
                                <label for="marca-<?= $aprendizId ?>">Marca del Computador</label>
                                <input type="text" class="form-control" id="marca-<?= $aprendizId ?>" name="marca">
                            </div>
                            <div class="form-group mb-3">
                                <label for="codigo-<?= $aprendizId ?>">Código del Computador</label>
                                <input type="text" class="form-control" id="codigo-<?= $aprendizId ?>" name="codigo">
                            </div>
                        <?php else: ?>
                        ...
                        <div class="d-flex gap-2">
                            <button type="button" class="btn btn-success btn-lg fw-bold w-100" onclick="finalizarProceso('<?= $aprendizId ?>')">Finalizar</button>
                            <button type="button" class="btn btn-outline-secondary btn-lg w-100" onclick="closeActiveModal()">Cerrar</button>
                        </div>
                    </div>
